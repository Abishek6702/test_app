  ...
  return (
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mb-[8ch]'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
        <div className="w-full h-auto rounded-xl bg-zinc-200/30 dark:bg-zinc-800/20 p-8 flex flex-col sm:flex-row items-center gap-x-3 shadow-md">
          <img src={Save} alt="save img" className="w-52 aspect-[2/1] object-contain object-center mb-4 sm:mb-0 sm:mr-4" />
          <div className="flex flex-1 flex-col space-y-5">
            ...
            <p className="text-sm text-neutral-400 dark:text-neutral-600 font-normal">
              Valid till: <span className="text-sm font-medium">31st Dec</span>
            </p>
          </div>
        </div>
