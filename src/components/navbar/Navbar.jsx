...
const Navbar = () => {
    ...
    return (
        <div className="w-full h-[8ch] bg-neutral-100 dark:bg-neutral-900 flex items-center lg:px-28 md:px-16 sm:px-7 px-4 fixed top-0 z-50">
            {/* Logo section */}
            ...
            <button onClick={handleClick} className="lg:hidden text-neutral-600 dark:text-neutral-300 ease-in-out duration-300 flex items-center justify-end">
                {open ? (
            ...
            {/* Navigation links */}
            <div className={`${open ? 'flex absolute top-14 left-0 w-full h-auto bg-neutral-100 md:bg-transparent shadow-md rounded-md' : 'hidden'} flex-1 md:flex flex-col md:flex-row gap-x-5 gap-y-2 md:items-center md:p-0 sm:p-4 p-4 justify-between`}>
                ...
                {/* Contact and Theme toggle section */}
                <div className="flex md:items-center items-start gap-x-5 gap-y-2 flex-wrap md:flex-row flex-col text-base font-medium text-neutral-800">
                    <Link to="/contact" className="relative bg-violet-600 rounded-md px-8 py-2 w-fit cursor-pointer">
